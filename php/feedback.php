   ...
   <div class="modal-dialog" role="document">
      <div class="modal-content">
         ...
         <div class="modal-body">
            ...
            $fetch1 = mysqli_fetch_assoc($getresult1);
            ...
            <div class="form-group">
               <input type="text" name="servicetype" id="servicetype" class="form-control" value="<?php echo $fetchs["category"]; ?>" placeholder="<?php echo $fetchs["category"]; ?>" readonly />
            </div>
            <div class="form-group">
            ...
            success: function(data) {
               ...
               if (data.review_data.length > 0) {
                  ...
                  for (var count = 0; count < data.review_data.length; count++) {
                     ...
                     var output2 = data.review_data[count].serviceid;
                     // document.write(output2);
                     // console.log(output2);

                     if (data.review_data[count].fullname == output) {
                        html += '<a class="far fa-edit" href="editfeedback.php?id=' + output2 + '" style="font-size: 100%; color: blue; margin-left:810px; margin-top:-50px; margin-right:7px;"></a>';
                        html += '<a href="deletefeedback.php?id=' + output2 + '" class="fas fa-trash-alt" style="color:red;"></a>';
                     }
                     html += '<br />';
                     html += '<br />';
